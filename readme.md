...
আমরা যখন অনেক গুলো ডাটা নিয়ে কাজ করবো তখন একসাথে সব গুলো ডাটা আমরা দিবো না, সবগুলো দিলে পারফর্মেন্স ইস্যু হবে যার ফলে ডাটা লোড নিতে অনেক সময় নিবে। এর জন্য আমরা একসাথে সব গুলো ডাটা না দিয়ে অল্প করে ডাটা গুলো দিবো যাতে আমাদের এপলিকেশন এর পারফর্মেন্স ইস্যু না হয় ।

এইটাকে বলা হয় প্যাজিনেশন

```sql
SELECT * FROM students LIMIT 5;
```

এখানে আমরা বলে দিছি যে একবারে ৫ টা ডাটা দেয়ার লিমিট দিয়ে দিছি এই LIIMIT keyword দিয়ে।

আমরা চাইলে কম বেশি লিমিট দিতে পারি।

আমরা চাইলে বলে দিতে পারি প্রতি পেজে কত করে লিমিট হবে

```sql
SELECT * FROM student LIMIT 5 OFFSET 0;
```

আমরা জানি পেজ সবসময় শুন্য বা জিরো থেকে শুরু হয় যার কারনে আমরা বলে দিছি যে এক নাম্বার পেজে ৫ টা ডাটা শো করবে;

আমরা যদি চাই সব গুলা পেজের জন্য পাচটা করে ডাটা থাকবে সেক্ষেত্রে আমরা এইভাবে লিখতে পারি।
...
এভাবে আমরা বলে দিতে পারি আমাদের প্রতি পেজের ডাটা গুলো;

আমরা LIMIT এবং OFFSET ব্যবহার করি আমাদের এপ্লিকেশন যাতে স্কেলেবল হয় এবং পারফর্মেন্ট হয়।
